...
- **Quelle:** `core/ai.py:288` (`_SYSTEM_PROMPT`)
- **Live-Sprache:** de
...
- **`_DASHBOARD_VIEW`** (`core/ai.py:268`): eine kompakte Beschreibung, was Sasha
  ...
  abschaltbar.
- **`ANTWORT_SUFFIX`** (`core/ai.py:858`): „Deine finale Antwort lieferst du
...
- **`_ASCII_MARKER_PROMPT`** (`core/ai.py:875`, „## Visuelle Stimme"): erklärt den
