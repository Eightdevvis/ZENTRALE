...
| `⌫`          | letzte geschriebene Note weg (wie beim Tippen von Text)          |
| `L` (groß)   | Tastenbeleuchtung: neon → regenbogen → aus — `l` ist die Taste A♯ |
...
Pfeiltaste kam — siehe `memory/ki/audio_system.md`). Siehe `memory/system/dashboard.md`,
...
Beschreibung: `memory/werkzeuge/morgen_messenger.md`.
