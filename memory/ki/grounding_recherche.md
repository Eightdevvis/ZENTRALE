...
3. 🔴 **Später:** Abstention/Tool-Use ins Modell fine-tunen
   ([[memory/ki/ki_personality_plan.md]]), wenn der Rest ausgereizt ist.
...
(ABSAGEN-Zeile, 30→60 %, [[memory/werkzeuge/kalender_system.md]]).
...
(`monolith.html`/`engine.js`) — NICHT die veraltete `memory/system/dashboard.md` (die beschrieb
...
schließt. Quelle ist das ECHTE UI, nicht die (jetzt bereinigte) memory/system/dashboard.md.
...
> [[memory/ki/bench_history.md im Repo]] (Sampling-Korrektur). Der Text unten = historischer
...
- ✅ **Daten-Präsentation** — sauber isoliert belegt (N=20, prod-treu temp 0.7,
  ein Rädchen, [[memory/ki/bench_history.md im Repo]] 1b): **ABSAGEN-Zeile +25pp Episode,
...
- Roter Faden: das 9B rahmt auf Aktions-/ersten Turns leicht falsch; was hilft, sind
  ...
  ([[memory/ki/ki_personality_plan.md]]) für den Rest-Schwanz; `_should_think`-Heuristik bei
...
nie. Voll: [[memory/ki/bench_history.md im Repo]] 2b. Bestätigt das Reasoning-Gap-vs-Daten-Gap-
