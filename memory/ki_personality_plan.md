...
- Memory-System: → `ki_memory_plan.md` (archiviert) und `ki_system.md`.
- Tool-Use, Capabilities-Prompt: → `ki_system.md`.
...
- `ki_system.md` – aktuelle KI-Architektur (Ollama, Graph, Tools)
- `ki_memory_plan.md` – Memory-System-Historie und -Designprinzipien
- `claude_hinweise.md` – Tool-Use-Konventionen
- `setup.md` – wenn `ml/`-Dependencies dazukommen, dort dokumentieren
